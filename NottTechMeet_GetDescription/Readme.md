...
```
    cd "NottTechMeet_GetDescription"
    dotnet restore
```

Execute unit tests
```
    cd "NottTechMeet_GetDescription/test/NottTechMeet_GetDescription.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "NottTechMeet_GetDescription/src/NottTechMeet_GetDescription"
